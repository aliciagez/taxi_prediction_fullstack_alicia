...
Frontend: 
For the frontend with streamlit i wanted to have some diffrent pages so its just not one page and so the predicons could have their own page and one home and one for the raw data and one home page with some introduction. I focused more on the pratical aspects then the estetics. i added default values that is already filled in and can be chaged by a use if needed. 


---------------------------------------------------------------------------------------------------------------------------------------------

Screenshots of steamlit in assets map
